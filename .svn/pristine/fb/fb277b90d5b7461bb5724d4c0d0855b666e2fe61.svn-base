...
unsigned char *snake_x;
unsigned char *snake_y;
unsigned char *snake_z;

/*
unsigned char snake_x[SNAKE_SIZE];
unsigned char snake_y[SNAKE_SIZE];
...
TG12
Lagt til NES kontroller

2012-05-03
Endret NES kotrollerinput
